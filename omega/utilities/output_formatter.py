...
Generates standardized output tables and narrative structure per Required Output Format requirements.

Functions:
    - format_full_suggested_bets_table: Full summary table for all markets
    - format_straight_bets_table: Game bets table (spread/total/ML)
    - format_props_only_table: Player props table
    - format_clv_tracking_table: CLV tracking table
    - format_rejected_bets_log: Rejected bets log
    - format_context_drivers_table: Context drivers table
    - format_risk_stake_table: Risk and stake table
    - format_simulation_summary_table: Simulation summary table
    - format_narrative_analysis: Narrative analysis section
    - format_full_output: Complete formatted output
"""
...
def format_clv_tracking_table(clv_data: List[Dict[str, Any]]) -> str:
    ...
    Args:
        clv_data: List of CLV tracking dictionaries
    
    Returns:
        Markdown-formatted table string (empty string if no data)
    """
    if not clv_data:
        return ""
...
def format_rejected_bets_log(rejected_bets: List[Dict[str, Any]]) -> str:
    ...
    Args:
        rejected_bets: List of rejected bet dictionaries
...
def format_narrative_analysis(
    bet_data: Dict[str, Any],
    context_data: Dict[str, Any],
    sim_results: Dict[str, Any],
    module_citations: Optional[List[str]] = None
) -> str:
    """
...
def format_full_output(
    ...
    module_citations: Optional[List[str]] = None,
    rejected_bets: Optional[List[Dict[str, Any]]] = None,
    clv_data: Optional[List[Dict[str, Any]]] = None
) -> str:
    """
