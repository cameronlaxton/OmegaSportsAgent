...
Centralized league-specific configuration parameters (periods, clock rules,
scoring rules, typical possession counts, etc.).
"""
...
LEAGUE_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    "NFL": {
        ...
        "overtime_length_minutes": 10.0,
        "typical_drives_per_game": 12.0,
    ...
    "MLB": {
        "periods": 9,
        "period_length_outs": 3,
        "overtime_innings": True,
        ...
        "clock_rules": {
            "no_clock": True,
            "pitch_clock_seconds": 15.0,
            "inning_ends": "three_outs"
        },
        "key_numbers": [1, 2, 3, 4, 5],
    ...
    "NHL": {
        ...
        "overtime_length_minutes": 5.0,
        "typical_shifts_per_game": 50.0,
        "typical_shots_per_game": 30.0,
    ...
    "NCAAF": {
        "periods": 4,
        "period_length_minutes": 15.0,
        "overtime_length_minutes": 0.0,
        "typical_drives_per_game": 12.0,
        "typical_plays_per_drive": 6.0,
        "typical_seconds_per_play": 25.0,
        "scoring": {
            "touchdown": 6,
            "field_goal": 3,
            "safety": 2,
            "two_point_conversion": 2,
            "extra_point": 1,
            "typical_points_per_drive": 2.5
        },
        "clock_rules": {
            "play_clock_seconds": 40.0,
            "game_clock_stops": True,
            "first_down_clock_stops": True,
    ...
    "NCAAB": {
        ...
        "period_length_minutes": 20.0,
        "overtime_length_minutes": 5.0,
        "typical_possessions_per_game": 70.0,
        "typical_seconds_per_possession": 18.0,
        "scoring": {
            "field_goal": 2,
            "three_pointer": 3,
            "free_throw": 1,
            "typical_points_per_possession": 1.0
        },
        "clock_rules": {
            "shot_clock_seconds": 30.0,
            "game_clock_stops": True,
            "overtime_rules": "5_min_periods"
        },
        "key_numbers": [3, 4, 7],
...
def get_typical_possessions(league: str) -> float:
    ...
    if league == "NBA" or league == "NCAAB":
        ...
        return config.get("typical_drives_per_game", 12.0) * 2
    elif league == "NHL":
        return config.get("typical_shifts_per_game", 50.0) * 2
    elif league == "MLB":
