...
from src.data.nfl_stats import NFLTeamContext, NFLPlayerContext
...
class OmegaSimulationEngine:
    ...
    def run_fast_game_simulation(
        ...
        """
        from src.data.stats_ingestion import get_team_context, TeamContext
        from src.simulation.markov_engine import validate_team_context
        from src.data.nfl_stats import get_nfl_team_context
    ...
    def run_player_prop_simulation(
        ...
        """
        from src.data.stats_ingestion import get_game_context, get_player_context
        from src.simulation.markov_engine import MarkovSimulator
