"""
LEGACY SQLAlchemy ORM Models for OMEGA Sports Betting Platform.
Multi-sport support: NFL, NBA, MLB, NHL, CFB.

DEPRECATED: This module uses database.py's Base, which is NOT tracked by Alembic.
The active schema is src/db/schema.py (Hybrid JSONB Schema).
This file is retained only for backwards compatibility with seed.py.
New code should use src.db.schema models.
"""
